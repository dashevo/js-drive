...
class DapObjectMongoDbRepository {
  ...
  async find(id) {
    ...
    const previousVersions = this.toPreviousVersions(result.previousVersions);
    return this.toDapObject(blockchainUserId, objectState, referenceState, previousVersions);
  }
  ...
  toDapObject(blockchainUserId, objectState = {}, referenceState = {}, previousVersions = []) {
    ...
    return new DapObject(blockchainUserId, objectState, reference, previousVersions);
  }
