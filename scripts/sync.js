...
(async function main() {
  ...
  attachPinSTPacketHandler(stHeaderReader, ipfsAPI, unpinAllIpfsPackets);
  ...
  attachStoreDapContractHandler(stHeaderReader, storeDapContract, dropMongoDatabasesWithPrefix);
