...
const BlockExecutionTransactionStore = require('./blockExecution/BlockExecutionTransactionStore');
...
const updateMongoDbFromStoreTransactionFactory = require('./document/updateMongoDbFromStoreTransactionFactory');
 ...
 * @param {string} options.BLOCK_EXECUTION_TRANSACTIONS_MERK_DB_FILE
...
async function createDIContainer(options) {
  ...
  container.register({
    ...
    blockExecutionTransactionDBFile: asValue(options.BLOCK_EXECUTION_TRANSACTIONS_MERK_DB_FILE),
  ...
  container.register({
    ...
    blockExecutionTransactionDB: asFunction((blockExecutionTransactionDBFile) => {
      const merkDb = new Merk(blockExecutionTransactionDBFile);
