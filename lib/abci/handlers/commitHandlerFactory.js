...
function commitHandlerFactory(
  ...
  async function commitHandler() {
    ...
    try {
      ...
      if (header.version.app.greaterThan(0)) {
        // Fixed the bug with overwriting cumulative fees by each block
