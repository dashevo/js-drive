...
const STHeadersReaderState = require('../blockchain/reader/header/STHeadersReaderState');
const STHeadersReader = require('../blockchain/reader/header/STHeadersReader');
...
class SyncApp {
  ...
  createSTHeadersReader() {
    ...
    return new STHeadersReader(
      stHeaderIterator,
      stHeadersReaderState,
      {
        initialBlockHeight: this.options.getSyncEvoStartBlockHeight(),
      },
    );
  }
