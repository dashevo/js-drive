...
class DapObjectMongoDbRepository {
  ...
  async find(id) {
    ...
    const { buid, object: objectState, reference: referenceState } = result || {};
    return this.toDapObject(buid, objectState, referenceState);
  }
  ...
  toDapObject(buid, objectState = {}, referenceState = {}) {
    ...
    return new DapObject(buid, objectState, reference);
  }
