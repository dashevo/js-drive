...
const merk = require("merk");
const CommonStore = require("./commonStore/CommonStore");
...
async function createDIContainer(options) {
   ...
   */
  container.register({
    commonStoreMerkDB: asFunction((commonStoreMerkDBFile) => merk(commonStoreMerkDBFile))
      .singleton(),
    commonStore: asClass(CommonStore).singleton(),
