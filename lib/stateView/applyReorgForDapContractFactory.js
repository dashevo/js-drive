 ...
 */
function applyReorgForDapContractFactory(
   ...
   */
  async function applyReorgForDapContract(staleBlock) {
  ...
  return applyReorgForDapContract;
}

module.exports = applyReorgForDapContractFactory;
