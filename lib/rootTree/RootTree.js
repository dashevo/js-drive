...
class RootTree {
  ...
  /**
   *
   * @param {AbstractRootTreeLeaf} storeTree
   * @param {Buffer[]} storeTreeKeys
   *
   * @return {Buffer} store tree proof
   */
  getStoreTreeProof(storeTree, storeTreeKeys) {
    // Just normal store tree proof as before
  }

  /**
   *
   * @param {AbstractRootTreeLeaf[]} storeTrees
   *
   * @return { rootTreeProof: Buffer, rootTreeFlags: boolean[] }
   */
  getRootTreeProof(storeTrees) {
    // Do multiproof and flags here
  }
