...
async function createDIContainer(options) {
  ...
  container.register({
    ...
    previousBlockExecutionStoreTransactionsRepository: asClass(PreviousBlockExecutionStoreTransactionsRepository)
      .singleton(),
    blockExecutionTransactionDB: asFunction((blockExecutionTransactionFile) => (
      new FileDb(blockExecutionTransactionFile)).singleton()),
