  ...
  async function getProofsQueryHandler(params, {
    ...
    if (identityIds && identityIds.length) {
      response.identitiesProof = {
        signatureLlmqHash,
        signature,
        ...previousRootTree.getFullProofForOneLeaf(previousIdentitiesStoreRootTreeLeaf, identityIds),
      };
    }
    ...
    if (dataContractIds && dataContractIds.length) {
      response.dataContractsProof = {
        signatureLlmqHash,
        signature,
        ...previousRootTree.getFullProofForOneLeaf(previousDataContractsStoreRootTreeLeaf, dataContractIds),
      };
    }
