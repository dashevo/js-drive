...
async function createDIContainer(options) {
  ...
  container.register({
    ...
    queryHandlerRouter: asFunction((
      ...
      router.on('GET', '/identities/by-public-key/:publicKeyHash', identityByPublicKeyQueryHandler);
      router.on('GET', '/identities/by-public-key/:publicKeyHash/id', identityIdByPublicKeyQueryHandler);
