...
const validateIndexedFields = require('../stateView/document/query/validateIndexedFields');
const getIndexedFieldsFromDocumentSchema = require('../stateView/document/getIndexedFieldsFromDocumentSchema');
