...
const fallbackChainLockSyncFactory = require('./core/fallbackChainLockSyncFactory');
const waitForCoreChainLockSyncFactory = require('./core/waitForCoreChainLockSyncFactory');
const getIsStandaloneRegtestModeFactory = require('./core/getIsStandaloneRegtestModeFactory');
...
async function createDIContainer(options) {
   ...
   */
  container.register({
    getIsStandaloneRegtestMode: asFunction(getIsStandaloneRegtestModeFactory).singleton(),
  });
  container.register({
    waitForCoreSync: asFunction(waitForCoreSyncFactory).singleton(),
  });
  container.register({
    fallbackChainLockSync: asFunction(fallbackChainLockSyncFactory).singleton(),
  });
  container.register({
