...
class DocumentsCombinedTransaction {
  /**
  ...
  async populateFromObject(transactionObject) {
    ...
    await this.populateMongoDbTransactionFromObject(
      this.getMongoDbTransaction(),
      transactionObject
    );
  }
}

module.exports = DocumentsCombinedTransaction;
