...
class SyncApp {
  ...
  constructor(options) {
    ...
    this.createStateTransitionsFromBlock = null;
  }
  ...
  createStateTransitionsFromBlock() {
    if (this.createStateTransitionsFromBlock) {
      this.createStateTransitionsFromBlock = createStateTransitionsFromBlockFactory(
        this.getRpcClient(),
      );
    }

    return this.createStateTransitionsFromBlock;
  }
