...
const SVObjectMongoDbRepository = require('../stateView/document/SVObjectMongoDbRepository');
const createSVObjectMongoDbRepositoryFactory = require('../stateView/document/createSVObjectMongoDbRepositoryFactory');
const updateSVContractFactory = require('../stateView/contract/updateSVContractFactory');
const updateSVObjectFactory = require('../stateView/document/updateSVObjectFactory');
const revertSVObjectsForStateTransitionFactory = require('../stateView/document/revertSVObjectsForStateTransitionFactory');
...
const fetchDPObjectsFactory = require('../stateView/document/fetchDPObjectsFactory');
