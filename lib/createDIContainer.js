 ...
 * @param {string} options.DPNS_CONTRACT_HEIGHT
...
async function createDIContainer(options) {
  ...
  container.register({
    ...
    dpnsContractHeight: asValue(
      options.DPNS_CONTRACT_HEIGHT !== undefined
        ? parseInt(options.DPNS_CONTRACT_HEIGHT, 10)
        : undefined,
    ),
    dpnsContractId: asValue(
      options.DPNS_CONTRACT_ID !== undefined
        ? Identifier.fromString(options.DPNS_CONTRACT_ID)
        : undefined,
    ),
