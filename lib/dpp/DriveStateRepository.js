class DriveStateRepository {
  ...
  async verifyInstantLock(instantLock) {
    try {
      return await instantLock.verify(this.simplifiedMasternodeList.getStore());
    } catch (e) {
      // eslint-disable-next-line no-console
      console.log('===');
      // eslint-disable-next-line no-console
      console.log(JSON.stringify(instantLock, null, 2));
      // eslint-disable-next-line no-console
      console.log(JSON.stringify(this.simplifiedMasternodeList.getStore(), null, 2));
