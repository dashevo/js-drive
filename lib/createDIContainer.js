...
async function createDIContainer(options) {
  ...
  container.register({
    ...
    previousBlockExecutionTransactionFile: asValue(options.PREVIOUS_BLOCK_EXECUTION_TRANSACTIONS_FILE),
  ...
  container.register({
    ...
    previousBlockExecutionTransactionDB: asFunction((blockExecutionTransactionFile) => (
      new FileDb(blockExecutionTransactionFile)
    )).singleton(),
