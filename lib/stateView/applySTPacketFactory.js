 ...
 * @returns {applySTPacket}
 */
function applySTPacketFactory(ipfs, updateDapContract, updateDapObject) {
  /**
   * @typedef {Promise} applySTPacket
   * @param {object} header
   * @param {object} block
   * @returns {Promise<void>}
   */
  async function applySTPacket(header, block) {
  ...
  return applySTPacket;
}

module.exports = applySTPacketFactory;
