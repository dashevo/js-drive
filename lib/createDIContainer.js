...
const DocumentDbTransaction = require('./document/DocumentsIndexedTransaction');
...
const populateMongoDbTransactionFromObject = require('./document/populateMongoDbTransactionFromObjectFactory');
const createPreviousDocumentDatabasesFromTransactionObjectFactory = require('./dataContract/createPreviousDocumentDatabasesFromTransactionObjectFactory');
...
async function createDIContainer(options) {
  ...
  container.register({
    ...
    createPreviousDocumentDatabasesFromTransactionObject:
      asFunction(createPreviousDocumentDatabasesFromTransactionObjectFactory).singleton(),
  });
