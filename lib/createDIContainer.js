...
const BlockExecutionDBTransaction = require('./blockchainState/blockExecution/BlockExecutionDBTransaction');
...
async function createDIContainer(options) {
  ...
  container.register({
    ...
    blockExecutionDBTransaction: asClass(BlockExecutionDBTransaction).singleton(),
