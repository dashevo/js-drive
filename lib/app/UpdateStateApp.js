...
class UpdateStateApp {
  ...
  async init() {
    ...
    console.log('updateState connecting to mongoDB');
    ...
    console.log('updateState creating mongoDB transaction');
    ...
    console.log('updateState creating collection');
    await this.svContractMongoDbRepository.createCollection();
    console.log('updateState collection created');
  }
