...
describe('syncDashCoreInstances', function main() {
  ...
  describe('Dash Core Instances', () => {
    ...
    it('should have different number of blocks even if `msync("next")` called a few times', async () => {
    ...
    it('should eventually have the same number of blocks if both instances connected', async () => {
      ...
      expect(firstBlockCount).to.be.equal(secondBlockCount);
    });

    it('should eventually have the same number of blocks if second instances connected to the first', async () => {
