...
module.exports = function attachSyncLogger(readerMediator, logger) {
  ...
  readerMediator.on(ReaderMediator.EVENTS.DOCUMENT_APPLIED, (params) => {
    ...
    const messages = {
      [SVObject.ACTION_CREATE]: `Created Document ${objectId} for ${contractId}`,
      [SVObject.ACTION_UPDATE]: `Updated Document ${objectId} for ${contractId}`,
      [SVObject.ACTION_DELETE]: `Deleted Document ${objectId} for ${contractId}`,
    };
