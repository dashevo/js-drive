...
const identityByPublicKeyQueryHandlerFactory = require('./abci/handlers/query/identityByPublicKeyQueryHandlerFactory');
const identityIdByPublicKeyQueryHandlerFactory = require('./abci/handlers/query/identityIdByPublicKeyQueryHandlerFactory');
...
async function createDIContainer(options) {
  ...
  container.register({
    ...
    identityByPublicKeyQueryHandler:
      asFunction(identityByPublicKeyQueryHandlerFactory).singleton(),
    identityIdByPublicKeyQueryHandler:
      asFunction(identityIdByPublicKeyQueryHandlerFactory).singleton(),
    ...
    queryHandlerRouter: asFunction((
      ...
      router.on('GET', '/identities/by-public-key-hash/:publicKeyHash', identityByPublicKeyQueryHandler);
      router.on('GET', '/identities/by-public-key-hash/:publicKeyHash/id', identityIdByPublicKeyQueryHandler);

      // TODO: remove in the next PR, keeping for functional test to work
      router.on('GET', '/identities/by-first-public-key/:publicKeyHash', identityByPublicKeyQueryHandler);
      router.on('GET', '/identities/by-first-public-key/:publicKeyHash/id', identityIdByPublicKeyQueryHandler);
