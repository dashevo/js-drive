...
module.exports = function attachSyncLogger(readerMediator, logger) {
  ...
  readerMediator.on(ReaderMediator.EVENTS.DAP_OBJECT_APPLIED, (params) => {
    ...
    const messages = {};
    messages[DapObject.ACTION_CREATE] = `Created DAP Object for ${dapId}`;
    messages[DapObject.ACTION_UPDATE] = `Updated DAP Object for ${dapId}`;
    messages[DapObject.ACTION_DELETE] = `Deleted DAP Object for ${dapId}`;
