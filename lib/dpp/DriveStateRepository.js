class DriveStateRepository {
  ...
  constructor(
    ...
    coreRpcClient,
    blockExecutionDBTransaction = undefined,
  ) {
    ...
    this.blockExecutionDBTransaction = blockExecutionDBTransaction;
  }
  ...
  getDBTransaction(name) {
    ...
    if (this.blockExecutionDBTransaction) {
      transaction = this.blockExecutionDBTransaction.getTransaction(name);
    }
